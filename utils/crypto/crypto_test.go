...
func TestAesStringEncrypt(t *testing.T) {
	res, err := AesStringEncrypt("source=SHDQEN&userid=oHQuEjlfivBvikmaMhbUNxwgH8nQ&serial1w=20171107001614214442&userdevice=KD1095458916&faultdevice=KD1095458916", "wechat-mobile-17")
